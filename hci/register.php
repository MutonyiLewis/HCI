	...
	<div class="wrapper">
		...
		<form action="" method="POST">
			<table class="tbl-30">
				...
				<tr>
					<td>Id,passport or Birth certificate number</td>
					<td><input type="text" name="username" placeholder="enter your id,passport or Birth certificate number" required=""></td>
				</tr>
				<tr>
					<td>Password:</td>
